"""Sinyal özellik çıkarımı: RMS, kurtosis, crest factor, peak (bkz. planning/15).
...
def extract_features(samples: Sequence[float]) -> SignalFeatures:
    ...
    return SignalFeatures(rms=rms, kurtosis=kurtosis, crest_factor=crest_factor, peak=peak)
