...
| 0007 | Katman 2 ML eşikleri kalibre değil; FFT bantları ertelendi | Kısmen yerini aldı ADR-0008 (eşik), ADR-0010 (FFT çıkarım), ADR-0011 (teşhis offline) |
...
| 0011 | FFT arıza teşhisi offline (canlı `anomaly_events` yok) | Kabul edildi |
